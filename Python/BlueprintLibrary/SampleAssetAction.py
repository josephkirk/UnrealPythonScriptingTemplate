...
class SamplePythonAssetAction(unreal.AssetActionUtility):
    ...
    def python_dump_asset_info():
        ...
        for asset in selected_assets:
            unreal.log("{} {} {}".format(asset.get_name(), asset.get_outermost(), asset.get_path_name()))
...
unreal_utils.register_editor_utility_blueprint("SampleAssetUtility", SamplePythonAssetAction)